# DESCRIPTION: Perform a quick PCA analysis using a matrix and a phenotype file.
# INPUT: The matrix has chromosome start-end information in the first three rows, and each subsequent column represents a sample.
# PHENOTYPE: The file containing phenotype information must include a column named "ID" with the same sample names found in the matrix. Additionally, it should have a "phenotype" column with the relevant phenotype information.
#-----------------------------
# Upload packages
